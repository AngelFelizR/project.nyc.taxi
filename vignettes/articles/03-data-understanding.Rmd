...
I doesn't make sense to have negative time or a 41 hour trip in New York
...
7. We need to omit any `base_passenger_fare` with negative values or value higher than  `r scales::comma(params$MaxBaseFare)` dollars.

...
To gain a deeper understanding of the starting trips at the zone level, we'll create a **wrapper function**. This function will display the top 5 most significant zones and generate an interactive map. This map will illustrate the location of each zone in relation to the remaining locations within each borough.s

##### start_zone {.tabset}

###### Manhattan

The highlighted zones are significant for tourists in Manhattan.

- **Meatpacking West Village**: This area is known for its hip vibe with many old buildings transformed into *fancy bars*, popular *nightclubs*, stylish *shops*, and trendy *restaurants*. Key attractions include:

  - The High Line Park
  - Whitney Museum of American Art
  - Chelsea Market.

- **Clinton (East|West)**: This area is home to several attractions such as:
...
- **Upper East Side (North|South)**: This area is renowned for its cultural institutions along:
...
- **Central Harlem (North)**: This area is home to several attractions such as:

  - Studio Museum in Harlem
  - Thomas Jefferson Park
  - Riverside Park

- **East Village**: Known for its vibrant *nightlife* and great *restaurants*. Attractions include:
...
Thank you for providing more information. Here are the shortened descriptions for the Brooklyn zones:

- **Bushwick (North|South)**: Known for its vibrant nightlife, art scene, dining, and secondhand shopping.
- **Crown Heights (North|South)**: A historic neighborhood with tree-lined streets, beautiful townhomes, and brownstones.
- **East New York**: A neighborhood in Brooklyn with a rich history and diverse community. It's undergoing significant changes and development¹.
- **Williamsburg (North Side)**: Information about tourism in Williamsburg North Side is limited. Please consider researching more about this area.
- **Park Slope**: A family-friendly neighborhood known for its beautiful brownstone-lined streets and proximity to Prospect Park.
...
TrainingTripsCleaned <-
  ...
  add_zone_description(zone_dt = ZoneCodesArcgisClean,
                       ...
                       zone_id_col = "LocationID") |>
  apply_base_cleaning() |>
  add_datetime_features(date_col = "request_datetime")
```

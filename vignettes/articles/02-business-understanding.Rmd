...
If we can apply a strategy that can move the `Daily Hourly Wage` to 60 dollars per hour ($ \frac{60 - 50}{50} = 20\% $) if woud be a be a great change for many taxi driver if they apply this strategy.

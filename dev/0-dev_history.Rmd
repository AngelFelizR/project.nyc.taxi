...
```
docker run --rm -ti -d --name project -p 8787:8787 -e "RENV_PATHS_CACHE=/renv/cache" -v C:/Users/angel/R-folder/renv_cache_project.nyc.taxi:/home/rstudio/renv/cache -v C:/Users/angel/R-folder/project.nyc.taxi:/home/rstudio/project angelfelizr/project.nyc.taxi:0.0.99
```
...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "A Data Analysis Project on NYC Taxi Drivers’ Earnings",
    Version = "0.0.99",
    Description = "In this package, you will find the tools needed to reproduce the analysis done in the project to help taxi drivers in NYC implement strategies that can help them increase their earnings.",
    `Authors@R` = c(
